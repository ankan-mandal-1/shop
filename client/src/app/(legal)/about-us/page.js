  ...
  return (
    ...
    <div className={styles.container}>
      ...
      <section className="get-started">
        ...
        <p>
          Don't wait any longer to bring your business idea to life. Sign up for free, and in just a few simple steps, you'll be on your way to owning a professional online store. Whether youre a seasoned entrepreneur or a first-time seller, Fleket is here to support you every step of the way.
        </p>
        <br/>
        <h2>Contact Us</h2><br/>
        <p>
