    ...
    <div className={styles.container}>
      ...
      <section className="features">
        ...
        <ul>
          ...
          <li>
            <strong>User-Friendly Website Builder</strong>: You dont need to be tech-savvy to design your store. Our drag-and-drop builder makes customization effortless, so you can focus on what matters most: your business.
          </li>
          <li>
          ...
          <li>
            <strong>Real Success Stories</strong>: Thousands of entrepreneurs have already taken the plunge with Fleket. Whether its Sarah T., who launched her handmade jewelry shop, or Mike L., who started selling vintage clothing, our platform has empowered them to make their entrepreneurial dreams a reality.
          </li>
        </ul>
      </section><br/>
      ...
      <section className="why-choose-us">
        ...
        <ul>
          ...
          <li>
            <strong>Easy-to-Use Interface</strong>: From your stores layout to adding products and managing orders, Fleket makes it effortless to build and run your online store.
          </li>
          <li>
      ...
      <section className="get-started">
        ...
        <p>
          Dont wait any longer to bring your business idea to life. Sign up for free, and in just a few simple steps, youll be on your way to owning a professional online store. Whether youre a seasoned entrepreneur or a first-time seller, Fleket is here to support you every step of the way.
        </p>
        <br/>
        <h2>Contact Us</h2><br/>
        <p>
